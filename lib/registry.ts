...
async function getToken(
	...
	authResponse: AuthRealmServiceResponseType,
	tag?: string,
) {
	try {
...
export async function pullManifestsFromRegistry(
	...
	const authRealmServiceResponse = await getRealmResponse(
		registryUrl,
		authHeaders,
	);
...
if (featureFlags.testRegistry) {
	const imageName =
		'registry2.77105551e3a8a66011f16b1fe82bc504.bob.local/v2/53b00bed7a4c6897db23eb0e4cf620e3' as string;
	const authHeaders = {
		username: 'bob',
